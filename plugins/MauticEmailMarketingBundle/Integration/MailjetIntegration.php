 ...
 */
class MailjetIntegration extends EmailAbstractIntegration
{
    ...
    public function getAvailableLeadFields ($settings = array())
    {
        ...
        foreach ($fields as $f) {
            $leadFields[$f] = array(
                'label'    => $this->factory->getTranslator()->trans('mautic.Mailjet.field.' . $f),
                'type'     => 'string',
        ...
        while ($c <= 15) {
            $leadFields['customfield_' . $c] = array(
                'label'    => $this->factory->getTranslator()->trans('mautic.Mailjet.customfield.' . $f),
                'type'     => 'string',
                'required' => false
            );
            $c++;
